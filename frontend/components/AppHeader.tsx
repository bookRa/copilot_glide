...
const AppHeader: NextComponentType = () => (
    <>
        <div className="grid grid-cols-3 text-7xl font-bold">
            ...
            <div className="py-4"><span className="float-left">🤖</span></div>
        </div>
        <h2 className='text-center text-2xl'>
            (Made with💖using {' '}
            <a
                className='hover:underline hover:decoration-orange-400 text-blue-600 visited:text-purple-900'
            ...
            {' '}
            <a
                className='hover:underline hover:decoration-indigo-600 text-red-500 visited:text-orange-600'
